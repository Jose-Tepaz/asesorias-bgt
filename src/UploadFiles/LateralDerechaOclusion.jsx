...
//assets
import add1 from '../assets/lateral-derecha.png';
...
const LateralDerechaOclusion = ({URLLateralDerechaOclusion}) => {
    ...
    try {
      console.log(e)
        ...
        if (res.status === 200) {
            ...
            URLLateralDerechaOclusion(file.secure_url);
        }; 
      } catch (error) {
        console.log(error);
      }  
  ...
  return (
    <div className='card-upload'>
      <div className='wrapp-head-text-component-uploiad'>
            ...
            <p className='info-text-strong'>Lateral derecha en oclusión</p>
      </div>
