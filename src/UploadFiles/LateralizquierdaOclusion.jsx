...
//assets
import add1 from '../assets/lateral-izquierda.png';
...
const LateralizquierdaOclusion = ({URLLateralizquierdaOclusion}) => {
    ...
    return;
      ...
      console.log(e)
        ...
        if (res.status === 200) {
            ...
            URLLateralizquierdaOclusion(file.secure_url);
        };   
  ...
  return (
    <div className='card-upload'>
      <div className='wrapp-head-text-component-uploiad'>
            ...
            <p className='info-text-strong'>Lateral izquierda en oclusión</p>
          </div>
      <div
      style={{
        display: 'grid',
...
export { LateralizquierdaOclusion };