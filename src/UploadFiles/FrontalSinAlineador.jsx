...
//assets
import add1 from '../assets/Frontal-sin-alineador.png';
...
const FrontalSinAlineador = ({URLFrontalSinAlineador}) => {
    ...
    try {
      console.log(e)
        ...
        if (res.status === 200) {
            ...
            URLFrontalSinAlineador(file.secure_url);
        };
      } catch (error) {
        console.log(error)
      }   
  ...
  return (
    <div className='card-upload'>
      <div className='wrapp-head-text-component-uploiad'>
            ...
            <p className='info-text-strong'>Frontal en oclusión sin alineadores</p>
          </div>
